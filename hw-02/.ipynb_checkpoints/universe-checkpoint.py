...
class Universe:
    ...
    def move_particles(self):
        """Moves the particles around the board."""
        for ip in self._all_particles:
            ip.move()

    def boundary_conditions(self):
        """Sets the conditions that ensure the particles will never leave the board."""
        for ip in self._all_particles:
            if ip.x > self.width:
                ip.x -= self.width
    ...
    def draw(self):
        """Places the particles onto the board and assigns colors and shapes."""
    ...
    def check_interaction(self):
        """Defines the rules for how the particles interact with each other. Created and
        deletes particles according to the rules."""
